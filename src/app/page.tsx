...
export default function Home() {
  return (
    <main className="font-mono w-full min-h-screen relative">
      <div className="absolute h-full w-full">
        <svg className="h-full w-full">
          <defs>
            <linearGradient id="shine" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0" style={{ stopColor: "var(--foreground)" }} stopOpacity="0" />
              <stop offset="0.5" style={{ stopColor: "var(--foreground)" }} stopOpacity="0.04" />
              <stop offset="1" style={{ stopColor: "var(--foreground)" }} stopOpacity="0" />
            </linearGradient>
          </defs>
          <pattern id="pattern" x="10" y="10" width="14.423223834988539" height="14.423223834988539" patternUnits="userSpaceOnUse" patternTransform="translate(-0.45072574484339184,-0.45072574484339184)">
            <circle cx="0.45072574484339184" cy="0.45072574484339184" r="0.45072574484339184" fill="#3e3e3e"></circle>
          </pattern>
          <rect x="0" y="0" width="100%" height="100%" fill="url(#pattern)" className=""></rect>
          <rect x="-100%" y="0" width="100%" height="100%" fill="url(#shine)" className="svg-shine"></rect>
        </svg>
      </div>
